...
|
*/
$config['base_url']	= 'http://localhost/Voyance/admin/';
...
|
*/
#### Si le fichier htaccess est créé alors on peut vider la variable index_page
## code natif $config['index_page'] = 'index.php';
$config['index_page'] = '';
...
|
*/
$config['log_date_format'] = 'm-Y-d H:i:s';
...
|
*/
$config['encryption_key'] = 'CXDUBLOIJLEIGNIT';
