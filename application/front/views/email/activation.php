		...
		<tr>
			...
			<table width="600" border="0" cellspacing="0" cellpadding="0" align="center">
				<tr>
							...
							<div class="contentEditableContainer contentTextEditable">
								<div class="contentEditable">
									<p style='text-align:center;margin:0;font-family:Georgia,Time,sans-serif;font-size:26px;color:#222222;'>
										Welcome to <span style='color:#289CDC;'>[CLIENTS.COMPANY_NAME]</span>
									</p>
								</div>
							</div></td>
						</tr>
									...
									<tr>
										...
										<div class="contentEditableContainer contentTextEditable">
											<div class="contentEditable" align='center'>
												<h1 style='text-align:left; color:#222222; font-size:19px;font-weight:normal;'>Will this be your welcome email?</h1>
											</div>
										</div></td>
									</tr>
					...
					ci <a href="<?php echo $activation_link; ?>">
									...
									<tr>
										...
										<table>
											<tr>
												...
												<div class="contentEditableContainer contentTextEditable">
													<div class="contentEditable" align='center'>
														<a href='#' style='font-size:16px;text-decoration:none;color:#ffffff;'>Activate your Account</a>
													</div>
												</div></td>
											</tr>
										</table></td>
							...
							<table width="520" border="0" cellspacing="0" cellpadding="0" align="center">
								<tr>
									...
									<div class="contentEditableContainer contentFacebookEditable">
										<div class="contentEditable">
											<a href="#"><img src="images/facebook.png" width='52' height='53' alt='facebook icon' data-default="placeholder" data-max-width="52"></a>
										</div>
									</div></td>
									...
									<div class="contentEditableContainer contentTwitterEditable">
										<div class="contentEditable">
											<a href="#"><img src="images/twitter.png" width='52' height='53' alt='twitter icon' data-default="placeholder" data-max-width="52"></a>
										</div>
									</div></td>
								</tr>
							</table></td>
